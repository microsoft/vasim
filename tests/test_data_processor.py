...
class TestDataProcessor(unittest.TestCase):
    ...
    def test_prepare_data_smooth(self) -> None:
    ...
    def test_prepare_data_no_smooth(self) -> None:
    ...
    def test_resample_dataframe(self) -> None:
    ...
    def test_get_workload_duration(self) -> None:
